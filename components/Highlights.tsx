...
const metricVariants: Variants = {
  ...
  show: (i: number) => ({
    scale: 1,
    opacity: 1,
    transition: { delay: 0.05 * i + 0.05, duration: 0.45, ease: [0.25, 0.46, 0.45, 0.94] },
  }),
};
            ...
            >
              <div className="flex flex-col  items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="mt-4 text-3xl font-semibold tracking-tight">{s.metric} {s.title}</h3>
              ...
              <div aria-hidden className="pointer-events-none absolute inset-0 rounded-2xl border border-white/3 mix-blend-overlay opacity-3" />
            </motion.article>
          ))}
        </motion.div>
      </div>
